...
public class IntentosFuga extends javax.swing.JDialog {
    ...
    public IntentosFuga(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha de fuga", "Fecha de reingreso"
            }
        ) {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 400, 110, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IntentosFuga dialog = new IntentosFuga(new javax.swing.JFrame(), true);
