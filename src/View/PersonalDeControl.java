...
public class PersonalDeControl extends javax.swing.JFrame {
    ...
    public void InicializarMenu() {
        ...
        JMenuItem historialMedicoPreso = new JMenuItem("Historial Médico");
        JMenuItem historialDeSanciones = new JMenuItem("Historial de sanciones");
        JMenuItem informacionPreso = new JMenuItem("Información preso");
        ...
        TablaPresos.setComponentPopupMenu(PPMenuPreso);
    }
    ...
    private void initComponents() {
        ...
        PanelBotones.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 260, 60));
        ...
        PanelBotones.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, 260, 60));
        ...
        PanelPerfil.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1100, 60));
    ...
    public static String obtenerNombreCompleto(String pNombre, String sNombre, String pApellido, String sApellido) {
        StringBuilder nombreCompleto = new StringBuilder(pNombre);

        if (sNombre != null && !sNombre.isEmpty()) {
            nombreCompleto.append(" ").append(sNombre);
        }
        nombreCompleto.append(" ").append(pApellido);

        if (sApellido != null && !sApellido.isEmpty()) {
            nombreCompleto.append(" ").append(sApellido);
        }
    ...
    private void limpiarCamposVisitante() {
        PrimerNombreVisitante.setText("");
        SegundoNombreVisitante.setText("");
        PrimerApellidoVisitante.setText("");
        SegundoApellidoVisitante.setText("");
    ...
    private void BotonAñadirVisitanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonAñadirVisitanteActionPerformed
        ...
        String nombreCompletoVisitante = obtenerNombreCompleto(primerNombre, segundoNombre, primerApellido, segundoApellido
        );
    ...
    private LocalTime parsearHora(String horaTexto) {
        try {
            ...
            System.err.println("Hora inválida: " + horaTexto);
            return null;
        }
    }
