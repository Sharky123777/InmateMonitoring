...
public class UsuarioDAO {
    ...
    // Método mejorado para cargar usuarios
    public List<Usuario> obtenerTodosUsuarios() throws IOException {
        ...
        // Maneja ambos formatos (array directo o objeto con propiedad "usuarios")
    ...
    private void guardarUsuarios(List<Usuario> usuarios) throws IOException {
        try (Writer writer = new FileWriter(JSON_FILE)) {
            gson.toJson(usuarios, writer); // Guarda como array directo
        }
    }
