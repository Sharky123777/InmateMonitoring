...
public class ModernTopMenu extends JPanel {
    ...
    private Color backgroundColor = new Color(15, 20, 30);
    private Color dropdownBgColor = new Color(25, 30, 45);
    ...
    private void setupMenuStructure() {
        ...
        ArrayList<MenuItem> directorItems = new ArrayList<>();
        directorItems.add(new MenuItem("Ver Perfil", 0));
        directorItems.add(new MenuItem("Disminuir Sentencia de un Recluso", 1));
        directorItems.add(new MenuItem("Añadir Delito", 2));
        menuStructure.put("Director", directorItems);

        ArrayList<MenuItem> enfermerasItems = new ArrayList<>();
        enfermerasItems.add(new MenuItem("Añadir Enfermera", 3));

        enfermerasItems.add(new MenuItem("Ver Lista de Enfermeras", 5));
        ...
        guardiasItems.add(new MenuItem("Ver Lista de Guardias", 8));
        menuStructure.put("Guardias", guardiasItems);

        ArrayList<MenuItem> oficialItems = new ArrayList<>();
        oficialItems.add(new MenuItem("Agregar oficial", 14));
        oficialItems.add(new MenuItem("Mostrar oficial", 16));
        menuStructure.put("Oficial", oficialItems);

        ArrayList<MenuItem> cdaItems = new ArrayList<>();
        cdaItems.add(new MenuItem("Agregar coordinadora", 9));

        cdaItems.add(new MenuItem("Mostrar coordinadora", 11));
        menuStructure.put("Coordinadora", cdaItems);

        ArrayList<MenuItem> ofrItems = new ArrayList<>();
        ofrItems.add(new MenuItem("Agregar registradora", 12));

        ofrItems.add(new MenuItem("Mostrar registradora", 13));
        menuStructure.put("Registradora", ofrItems);

        ArrayList<MenuItem> pdcItems = new ArrayList<>();
        pdcItems.add(new MenuItem("Agregar personal de control", 19));
        pdcItems.add(new MenuItem("Mostrar personal de control", 21));
        ...
        configItems.add(new MenuItem("Sistema", 14));
        menuStructure.put("Configuración", configItems);
    }
