...
public class GeneradorHistoriaClinica {
    ...
    public static void generarPDF(CitaMedica cita, File archivoDestino) {
        ...
        try {
            ...
            // Encabezado
            Paragraph titulo = new Paragraph("HISTORIA CLÍNICA DE RECLUSA", titleFont);
            ...
            addTableHeader(datosPaciente, "DATOS DE LA PACIENTE", headerFont, 2);
            ...
            if (cita.getPreso().getFotoPath() != null && !cita.getPreso().getFotoPath().isEmpty()) {
                try {
                    ...
                    System.err.println("Error al cargar imagen de la preso: " + e.getMessage());
            ...
            addTableCell(tablePersonal, "Enfermera atendió:", cita.getEnfermera().getNombreCompleto() + " (" + cita.getEnfermera().getIdentificacion() + ")", labelFont, valueFont);
